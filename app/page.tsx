...
const serviceCards: {
  ...
  },
  {
    ...
    imageSrc: "/images/realizations/chaudiere-allostef.png",
    imageAlt: "Chaudière murale installée par AlloStef",
    ...
    <>
      ...
      <main id="top">
        <section className="relative overflow-hidden py-14 sm:py-16 lg:py-20">
          ...
          <div className="hidden lg:block absolute right-0 top-0 w-[62vw] h-[780px] pointer-events-none overflow-hidden">
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-0" style={{
                  background: "linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(255,255,255,0.9) 15%, rgba(255,255,255,0.6) 35%, rgba(255,255,255,0.2) 60%, rgba(255,255,255,0) 100%)"
                }} />
                <div className="absolute inset-0" style={{
                  background: "linear-gradient(to bottom, rgba(255,255,255,0.3) 0%, rgba(255,255,255,0) 12%, rgba(255,255,255,0) 88%, rgba(255,255,255,0.2) 100%)"
                }} />
              </div>
            </div>
          </div>
          <div className="lg:hidden mx-auto max-w-[1200px] px-4 sm:px-6 mt-10">
            <div className="relative w-full rounded-[1.5rem] overflow-hidden h-80">
              <Image
                src="/assets/sdb-allostef.webp"
                alt="Intervention de plomberie avec équipements sanitaires installés"
                fill
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div style={{
                  background: "linear-gradient(to bottom, rgba(255,255,255,0.3) 0%, rgba(255,255,255,0) 15%, rgba(255,255,255,0) 85%, rgba(255,255,255,0.2) 100%)"
                }} />
              </div>
            </div>
          </div>
            ...
            {serviceCards.map((service) => (
              ...
              >
                <div className="flex flex-col gap-8 lg:flex-row lg:items-stretch lg:gap-10">
                  ...
                  <div className="overflow-hidden rounded-[1.1rem] border border-white/70 bg-white flex-shrink-0 lg:w-[38%] max-w-[500px]">
                    <div className="service-visual relative aspect-[4/3] h-56 sm:h-72 lg:h-80">
                      <Image
