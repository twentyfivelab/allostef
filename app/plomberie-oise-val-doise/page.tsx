    ...
    <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        <article className="rounded-[1.5rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)]">
          <h2 className="text-2xl font-semibold text-[#0D2345]">Dépannage plomberie rapide et soigné</h2>
        ...
        <article className="rounded-[1.5rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)]">
          <h2 className="text-2xl font-semibold text-[#0D2345]">Installation et remplacement de sanitaires</h2>
          <p className="mt-3 text-sm leading-7 text-[#5E7189]">
        ...
        <article className="rounded-[1.5rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)]">
          <h2 className="text-2xl font-semibold text-[#0D2345]">Recherche de fuite et mise en sécurité</h2>
          <p className="mt-3 text-sm leading-7 text-[#5E7189]">
        ...
        <article className="rounded-[1.5rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)]">
          <h2 className="text-2xl font-semibold text-[#0D2345]">Plomberie pour rénovation de salle de bain</h2>
          <p className="mt-3 text-sm leading-7 text-[#5E7189]">
      ...
      <section className="mt-10 rounded-[1.75rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)] sm:p-8">
        ...
        <p className="mt-3 text-sm leading-7 text-[#5E7189]">
          AlloStef intervient principalement dans l’Oise et le Val-d’Oise. Consultez la <a href="/#zones" className="font-semibold text-[#176BC0] hover:text-[#105BA7]">zone d’intervention</a> pour vérifier votre commune, puis présentez votre besoin via la section <a href="/#devis" className="font-semibold text-[#176BC0] hover:text-[#105BA7]">devis</a>.
        </p>
      </section>

      <section className="mt-10 rounded-[1.75rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)] sm:p-8">
        <h2 className="text-2xl font-semibold text-[#0D2345]">Questions fréquentes plomberie</h2>
      ...
      <section className="mt-10 rounded-[1.75rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)] sm:p-8">
        ...
        <p className="mt-3 text-sm leading-7 text-[#5E7189]">
          Selon votre projet, vous pouvez aussi consulter la page <Link href="/chauffagiste-oise-val-doise" className="font-semibold text-[#176BC0] hover:text-[#105BA7]">chauffage</Link> ou la page <Link href="/electricien-oise-val-doise" className="font-semibold text-[#176BC0] hover:text-[#105BA7]">électricité</Link>.
        </p>
      </section>
    </main>
  );
