...
export const metadata: Metadata = {
  title: "Electricien Oise et Val-d'Oise | Depannage et renovation electrique | AlloStef",
  description:
    "Besoin d'un electricien dans l'Oise ou le Val-d'Oise ? AlloStef intervient pour depannage, prises, eclairages, tableau electrique et travaux de renovation en toute fiabilite.",
  alternates: {
...
const faqItems = [
  {
    ...
    answer:
      "Oui. AlloStef intervient pour diagnostiquer l'origine de la panne et remettre l'installation en etat de fonctionnement en securite.",
  },
  {
    question: "Pouvez-vous moderniser un tableau electrique ?",
    answer:
      "Oui. Le tableau peut etre adapte ou remplace selon l'etat de l'installation et les besoins en securite et en distribution.",
  },
  {
    question: "Faites-vous les travaux electriques en renovation ?",
    answer:
      "Oui. Les travaux electriques peuvent etre integres a une renovation partielle ou globale en coordination avec les autres interventions.",
  },
  {
    question: "Comment obtenir un devis electricite ?",
    answer:
...
export default function ElectricitePage() {
    ...
    "@graph": [
      {
        ...
        name: "Electricite dans l'Oise et le Val-d'Oise",
        provider: {
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Electricite", item: `${siteConfig.siteUrl}/electricien-oise-val-doise` },
        ],
      },
    ],
  };
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      <Script id="schema-electricite" type="application/ld+json" strategy="beforeInteractive">
      ...
      <section className="mt-6 rounded-[2rem] border border-[#DDEFFF] bg-[linear-gradient(135deg,_#F8FCFF_0%,_#EFF8FF_45%,_#DDEFFF_100%)] p-7 sm:p-10">
        ...
        <h1 className="mt-4 max-w-[20ch] text-[clamp(2rem,4.4vw,3.3rem)] font-semibold leading-[1.08] tracking-[-0.03em] text-[#173246]">
          Electricite dans l'Oise et le Val-d'Oise : depannage, installation et renovation
        </h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-[#5F7484]">
          AlloStef realise les travaux electriques indispensables au bon fonctionnement du logement : depannage, prise et eclairage, intervention sur tableau electrique et adaptation en renovation.
        </p>
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        <article className="rounded-[1.5rem] border border-[#DDEFFF] bg-white p-6">
          <h2 className="text-2xl font-semibold text-[#173246]">Depannage electrique du quotidien</h2>
          <p className="mt-3 text-sm leading-7 text-[#5F7484]">
            Recherche de panne, remise en fonctionnement et controles de securite pour retablir l'usage normal de l'installation.
          </p>
        </article>
        <article className="rounded-[1.5rem] border border-[#DDEFFF] bg-white p-6">
          <h2 className="text-2xl font-semibold text-[#173246]">Installation et remplacement de prises et eclairages</h2>
          <p className="mt-3 text-sm leading-7 text-[#5F7484]">
            Pose ou remplacement d'equipements electriques avec attention portee au confort d'usage et a la fiabilite des branchements.
          </p>
        </article>
        <article className="rounded-[1.5rem] border border-[#DDEFFF] bg-white p-6">
          <h2 className="text-2xl font-semibold text-[#173246]">Intervention sur tableau electrique</h2>
          <p className="mt-3 text-sm leading-7 text-[#5F7484]">
            Diagnostic du tableau, ajustement de la distribution et securisation des circuits selon la configuration de votre bien.
          </p>
        </article>
        <article className="rounded-[1.5rem] border border-[#DDEFFF] bg-white p-6">
          <h2 className="text-2xl font-semibold text-[#173246]">Electricite pour renovation interieure</h2>
          <p className="mt-3 text-sm leading-7 text-[#5F7484]">
            Integration des travaux electriques dans un projet de renovation pour une installation plus pratique, plus sure et mieux adaptee aux usages.
          </p>
        </article>
      </section>
      ...
      <section className="mt-10 rounded-[1.75rem] border border-[#DDEFFF] bg-white p-6 sm:p-8">
        <h2 className="text-2xl font-semibold text-[#173246]">Questions frequentes electricite</h2>
