  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-5 text-4xl font-semibold tracking-[-0.02em] text-[#0D2345] sm:text-5xl">Mentions légales</h1>
        <p className="mt-4 text-sm text-[#5E7189]">Dernière mise à jour: {siteConfig.legalLastUpdated}</p>
        ...
        <section className="mt-10 space-y-8 rounded-[1.75rem] border border-[#E7EDF3] bg-white p-6 shadow-[0_16px_40px_-32px_rgba(13,35,69,0.16)] sm:p-8">
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Éditeur du site</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Informations sur l’entreprise</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Hébergement</h2>
            <p className="mt-3 leading-7 text-[#5E7189]">
              Vercel Inc.<br />
              440 N Barranca Avenue #4133<br />
              Covina, CA 91723<br />
              États-Unis<br />
              Site: <a href="https://vercel.com" className="text-[#176BC0] underline underline-offset-4">https://vercel.com</a><br />
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Conception et réalisation du site</h2>
            <p className="mt-3 leading-7 text-[#5E7189]">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Propriété intellectuelle</h2>
            <p className="mt-3 leading-7 text-[#5E7189]">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Responsabilité</h2>
            <p className="mt-3 leading-7 text-[#5E7189]">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Liens externes</h2>
            <p className="mt-3 leading-7 text-[#5E7189]">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Droit applicable</h2>
            <p className="mt-3 leading-7 text-[#5E7189]">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#0D2345]">Contact</h2>
            <ul className="mt-3 space-y-2 leading-7 text-[#5E7189]">
              <li>Téléphone: <a href={`tel:${siteConfig.phoneHref}`} className="text-[#176BC0] underline underline-offset-4">{siteConfig.phoneDisplay}</a></li>
              <li>E-mail: <a href={`mailto:${siteConfig.email}`} className="text-[#176BC0] underline underline-offset-4">{siteConfig.email}</a></li>
            </ul>
          </div>
        </section>
      </main>
