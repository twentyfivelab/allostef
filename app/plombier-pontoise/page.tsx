...
const faqItems = [
  {
    ...
    answer:
      "Oui. Les demandes de dépannage plomberie à Pontoise peuvent être traitees en priorité selon disponibilité.",
  },
  {
    question: "Proposez-vous le remplacement de robinetterie et sanitaires ?",
    answer:
      "Oui. Les remplacements de robinetterie, WC, lavabos et raccordements sont pris en charge avec contrôle de fonctionnement.",
  },
  {
    question: "Pouvez-vous etudier un projet de rénovation de salle de bain à Pontoise ?",
    answer:
      "Oui. Le projet est étudié globalement pour proposer une solution cohérente entre plomberie, implantation des équipements et usage quotidien.",
  },
];
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2">
        ...
        <article className="rounded-[1.5rem] border border-[#DDEFFF] bg-white p-6">
          ...
          <p className="mt-3 text-sm leading-7 text-[#5F7484]">
            Les interventions peuvent être étudiées autour de Pontoise, notamment vers Cergy, Saint-Ouen-l'Aumone, Osny et Eragny selon disponibilité et delai.
          </p>
          <p className="mt-3 text-sm leading-7 text-[#5F7484]">
